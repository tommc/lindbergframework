...
/**
 * 
 * Implementação de IExecutorValidation que efetua o processamento das validações <br>
 ...
 * 
 * Para  as validações comuns como notnnul, requiredField, etc...  a implementação padrão do {@link IExecutorValidation} <br>
 ...
 * são exemplos de validações candidatas a serem processadas por um {@link ExecutorValidationMultThread} 
 * 
...
@Scope("prototype")
public class ExecutorValidationMultThread extends ExecutorValidationImpl implements IExecutorValidation{
	
	public ExecutorValidationMultThread(){
		//
	}
